import { type Address, hexToBigInt, toHex } from "viem";
import { getContracts } from "@/src/lib/contracts";
import {
  type CollIndex,
  type CombinedTroveData,
  type PrefixedTroveId,
  type ReturnCombinedTroveReadCallData,
  type ReturnTroveReadCallData,
  type Trove,
  TroveStatus,
} from "@/src/types";
